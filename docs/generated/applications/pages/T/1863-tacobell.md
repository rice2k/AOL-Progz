...
| Field | Value |
| --- | --- |
| Archive ID | prog-1863-taco |
| Catalog number | 1863 |
| Best known name | Tacobell |
| Best name source | archive filename |
| Catalog label | TACO |
| Archive filename | tacobell.zip |
| File size | unknown |
| Author | unknown |
...
- Original source path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/tacobell.zip`
