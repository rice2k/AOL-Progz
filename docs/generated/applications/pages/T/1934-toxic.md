...
| Catalog number | 1934 |
| Best known name | Toxic |
| Best name source | archive filename |
| Catalog label | toxic |
| Archive filename | toxic.zip |
| File size | unknown |
| Author | unknown |
...
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/toxic.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/toxic.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/toxic.zip)
