...
| Field | Value |
| --- | --- |
| Archive ID | prog-0342-cak |
| Catalog number | 342 |
| Best known name | Cak |
| Best name source | archive filename |
| Catalog label | cak |
| Archive filename | cak.zip |
| File size | 2.9 MB |
...
- Local mirrored archive: [files/aol/aol-4-0/0342-cak.zip](../../../../../files/aol/aol-4-0/0342-cak.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/cak.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/cak.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/cak.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/cak.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/cak.zip)
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | cools aol killer | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/cak.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/cak.zip) | [http://lenshellarchive.com/Progs/aolprogs/cak.zip](http://lenshellarchive.com/Progs/aolprogs/cak.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: prog's/misc a-m | cak.zip | [http://lenshellarchive.com/Progs/aolprogs/cak.zip](http://lenshellarchive.com/Progs/aolprogs/cak.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/cak.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/cak.zip) | unknown | http-404 |
