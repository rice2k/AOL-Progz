...
| Field | Value |
| --- | --- |
| Archive ID | prog-0333-c-com |
| Catalog number | 333 |
| Best known name | Chillin 15 |
| Best name source | archive filename |
| Catalog label | c-com |
| Archive filename | chillin15.zip |
| File size | 71 KB |
| Author | unknown |
...
- Original source path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/chillin15.zip`
