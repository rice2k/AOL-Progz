...
| Field | Value |
| --- | --- |
| Archive ID | prog-0431-codegennapi |
| Catalog number | 431 |
| Best known name | CodeGennAPI |
| Best name source | catalog |
| Catalog label | CodeGennAPI |
| Archive filename | codegennapi.zip |
| File size | 1.3 MB |
...
- Local mirrored archive: [files/aol/aol-4-0/0431-codegennapi.zip](../../../../../files/aol/aol-4-0/0431-codegennapi.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/codegennapi.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/codegennapi.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/codegennapi.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/codegennapi.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/codegennapi.zip)
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | code gen & api spy | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/codegennapi.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/codegennapi.zip) | [http://lenshellarchive.com/Progs/aolprogs/codegennapi.zip](http://lenshellarchive.com/Progs/aolprogs/codegennapi.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: prog's/misc a-m | codegennapi.zip | [http://lenshellarchive.com/Progs/aolprogs/codegennapi.zip](http://lenshellarchive.com/Progs/aolprogs/codegennapi.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/codegennapi.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/codegennapi.zip) | unknown | http-404 |
