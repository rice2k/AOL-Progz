...
| Field | Value |
| --- | --- |
| Archive ID | prog-0368-chain-lightning-pwsd |
| Catalog number | 368 |
| Best known name | Chain Lightning PWSD |
| Best name source | catalog |
| Catalog label | Chain Lightning PWSD |
| Archive filename | chain.zip |
| File size | 1.3 MB |
| Author | 1.3 (catalog-only claim) |
