...
The catalog metadata and filename do not identify a confident single function yet. These need readme/source review or isolated inspection. Readable archive text also suggests: Punter / booter, Source / developer file, Account / TOS utility, Screen-name utility, Media / file utility, AOL/AIM chat utility.
...
| Field | Value |
| --- | --- |
| Archive ID | prog-0491-cube |
| Catalog number | 491 |
| Best known name | Cubepunt |
...
| Platform | AOL |
| AOL/version bucket | AOL 4.0; archive text: AOL 3, AOL 4, AOL 4.0 |
...
Readable archive text also mentions: **AOL 3, AOL 4, AOL 4.0**.
