...
| Field | Value |
| --- | --- |
| Archive ID | prog-0358-cdw |
| Catalog number | 358 |
| Best known name | Ao Wizard 2 |
| Best name source | archive filename |
| Catalog label | CDW |
| Archive filename | AoWizard 2.zip |
| File size | 1.2 MB |
| Author | XxWizardxX and WiZaRd666 (catalog-only claim) |
...
| --- | --- | --- | --- | --- | --- | --- |
| AoWizard/CDW.INI<br>__MACOSX/AoWizard/._CDW.INI<br>CDW.INI | none | none | none | none | none | unknown |
