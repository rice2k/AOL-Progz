...
| --- | --- | --- | --- | --- | --- | --- |
| Antilag/Description.txt<br>aciddr0p.netReadMe.txt | none | Screen-name utility | AOL 9.0 | none | none | Antilag/Description.txt mentions AOL 9.0.<br>Antilag/Description.txt has vocabulary for Screen-name utility.<br>aciddr0p.netReadMe.txt includes a mirror/download-source note. |
