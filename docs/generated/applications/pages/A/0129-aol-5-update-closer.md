...
| Field | Value |
| --- | --- |
| Archive ID | prog-0129-aol-5-update-closer |
| Catalog number | 129 |
| Best known name | AOL 5 Update Closer |
| Best name source | catalog |
| Catalog label | AOL 5 Update Closer |
| Archive filename | aol5udclose.zip |
| File size | 1.3 MB |
| Author | Trip (catalog-only claim) |
