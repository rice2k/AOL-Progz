...
| Field | Value |
| --- | --- |
| Archive ID | prog-0163-asciishop |
| Catalog number | 163 |
| Best known name | asciishop |
| Best name source | catalog |
| Catalog label | asciishop |
| Archive filename | asciishop.zip |
| File size | 98 KB |
| Author | Bizkit (catalog-only claim) |
