...
The catalog metadata and filename do not identify a confident single function yet. These need readme/source review or isolated inspection. Filename/catalog cues suggest: room buster vocabulary. Readable archive text also suggests: Source / developer file.
...
| Field | Value |
| --- | --- |
| Archive ID | prog-0140-aol7roombuster |
| Catalog number | 140 |
| Best known name | aol7roombuster |
| Best name source | catalog |
| Catalog label | aol7roombuster |
| Archive filename | drsubsbuster.zip |
| File size | 1.4 MB |
| Author | unknown |
...
- Local mirrored archive: [files/aol/aol-4-0/0140-aol7roombuster.zip](../../../../../files/aol/aol-4-0/0140-aol7roombuster.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/drsubsbuster.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/drsubsbuster.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/drsubsbuster.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/drsubsbuster.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/drsubsbuster.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| READ ME!.txt | none | Source / developer file | none | none | none | READ ME!.txt has vocabulary for Source / developer file. |
...
| --- | --- | --- | --- |
| LensHell busters | drsub's room buster | [https://web.archive.org/web/20110906025742/http://lenshellarchive.com/Progs/aolbusters/drsubsbuster.zip](https://web.archive.org/web/20110906025742/http://lenshellarchive.com/Progs/aolbusters/drsubsbuster.zip) | [http://lenshellarchive.com/Progs/aolbusters/drsubsbuster.zip](http://lenshellarchive.com/Progs/aolbusters/drsubsbuster.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: buster's | drsubsbuster.zip | [http://lenshellarchive.com/Progs/aolbusters/drsubsbuster.zip](http://lenshellarchive.com/Progs/aolbusters/drsubsbuster.zip) | [https://web.archive.org/web/20110906025742/http://lenshellarchive.com/Progs/aolbusters/drsubsbuster.zip](https://web.archive.org/web/20110906025742/http://lenshellarchive.com/Progs/aolbusters/drsubsbuster.zip) | unknown | http-404 |
