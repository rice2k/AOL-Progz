...
| Field | Value |
| --- | --- |
| Archive ID | prog-0167-assist |
| Catalog number | 167 |
| Best known name | assist |
| Best name source | catalog |
| Catalog label | assist |
| Archive filename | assist.zip |
| File size | 1.4 MB |
| Author | unknown |
...
- Original source path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/assist.zip`
- Source repository URL: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/assist.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/assist.zip)
