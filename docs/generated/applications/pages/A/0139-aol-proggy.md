...
| Field | Value |
| --- | --- |
| Archive ID | prog-0139-aol-proggy |
| Catalog number | 139 |
| Best known name | AOL proggy |
| Best name source | catalog |
| Catalog label | AOL proggy |
| Archive filename | revtoolz.zip |
| File size | 1.4 MB |
| Author | James |
...
| Catalog author | James |
| Manual author evidence | unknown |
| Archive-text author | James |
...
| Archive-text description clues | I can't be blamed for whatever damage this program causes you in anyway! ANYWAYS! physically or mentally! That goes for everyone around you and all you're belongings! It shouldn't damage you're computer though! |
| Archive-text URL clues | unknown |
| External ZIP text purpose clues | unknown |
| Archive text files reviewed | Rev Toolz/Read Me First.txt |
...
- Local mirrored archive: [files/aol/aol-4-0/0139-aol-proggy.zip](../../../../../files/aol/aol-4-0/0139-aol-proggy.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/revtoolz.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/revtoolz.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/revtoolz.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/revtoolz.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/revtoolz.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| Rev Toolz/Read Me First.txt | James (Rev Toolz/Read Me First.txt) | Source / developer file | none | I can't be blamed for whatever damage this program causes you in anyway! ANYWAYS! physically or mentally! That goes for everyone around you and all you're belongings! It shouldn't damage you're computer though! | none | Rev Toolz/Read Me First.txt includes archive-text author clue(s): James.<br>Rev Toolz/Read Me First.txt has vocabulary for Source / developer file. |
...
| --- | --- | --- | --- |
| LensHell misc progs N-Z | revolution tools | [https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/revtoolz.zip](https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/revtoolz.zip) | [http://lenshellarchive.com/Progs/aolprogs/revtoolz.zip](http://lenshellarchive.com/Progs/aolprogs/revtoolz.zip) |
