...
| File size | 1.5 MB |
| Author | Knúcklës (catalog-only claim) |
...
| --- | --- | --- | --- | --- | --- | --- |
| Read_me.txt | none | All-in-one prog suite<br>AOL/AIM chat utility | AOL 4.0<br>AOL 5.0<br>AOL 6 | none | none | Read_me.txt mentions AOL 4.0, AOL 5.0, AOL 6.<br>Read_me.txt has vocabulary for All-in-one prog suite, AOL/AIM chat utility. |
