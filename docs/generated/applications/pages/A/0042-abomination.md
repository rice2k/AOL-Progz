...
| Field | Value |
| --- | --- |
| Archive ID | prog-0042-abomin |
| Catalog number | 42 |
| Best known name | Abomination |
| Best name source | archive filename |
| Catalog label | abomin |
| Archive filename | abomination for aol 4.0.zip |
| File size | 22 B |
| Author | unknown |
