...
| Field | Value |
| --- | --- |
| Archive ID | prog-1567-quik-error-v1-up-d |
| Catalog number | 1567 |
| Best known name | QUIK ERROR V1 UP D |
| Best name source | catalog |
| Catalog label | QUIK ERROR V1 UP D |
| Archive filename | quikerror.zip |
| File size | 582 KB |
| Author | unknown |
...
- Local mirrored archive: [files/aol/aol-4-0/1567-quik-error-v1-up-d.zip](../../../../../files/aol/aol-4-0/1567-quik-error-v1-up-d.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/quikerror.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/quikerror.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/quikerror.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/quikerror.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/quikerror.zip)
...
| --- | --- | --- | --- |
| LensHell punters | quik error | [https://web.archive.org/web/20110904003420/http://lenshellarchive.com/Progs/aolpunters/quikerror.zip](https://web.archive.org/web/20110904003420/http://lenshellarchive.com/Progs/aolpunters/quikerror.zip) | [http://lenshellarchive.com/Progs/aolpunters/quikerror.zip](http://lenshellarchive.com/Progs/aolpunters/quikerror.zip) |
