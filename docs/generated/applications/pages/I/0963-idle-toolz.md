...
| Field | Value |
| --- | --- |
| Archive ID | prog-0963-idle-toolz |
| Catalog number | 963 |
| Best known name | Idle Toolz |
| Best name source | catalog |
| Catalog label | Idle Toolz |
| Archive filename | idletoolz1.zip |
| File size | 1.3 MB |
| Author | font><font face="arial" color=#000fff (catalog-only claim) |
...
| Catalog author | font><font face="arial" color=#000fff |
...
- Local mirrored archive: [files/aol/aol-4-0/0963-idle-toolz.zip](../../../../../files/aol/aol-4-0/0963-idle-toolz.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/idletoolz1.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/idletoolz1.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/idletoolz1.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/idletoolz1.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/idletoolz1.zip)
...
| --- | --- | --- | --- |
| LensHell idlers | idle toolz 1.0 | [https://web.archive.org/web/20110731021936/http://lenshellarchive.com/Progs/aolidlers/idletoolz1.zip](https://web.archive.org/web/20110731021936/http://lenshellarchive.com/Progs/aolidlers/idletoolz1.zip) | [http://lenshellarchive.com/Progs/aolidlers/idletoolz1.zip](http://lenshellarchive.com/Progs/aolidlers/idletoolz1.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell idlers | idletoolz1.zip | [http://lenshellarchive.com/Progs/aolidlers/idletoolz1.zip](http://lenshellarchive.com/Progs/aolidlers/idletoolz1.zip) | [https://web.archive.org/web/20110731021936/http://lenshellarchive.com/Progs/aolidlers/idletoolz1.zip](https://web.archive.org/web/20110731021936/http://lenshellarchive.com/Progs/aolidlers/idletoolz1.zip) | unknown | http-404 |
