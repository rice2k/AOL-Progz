...
| Field | Value |
| --- | --- |
| Archive ID | prog-0955-ics |
| Catalog number | 955 |
| Best known name | Ics |
| Best name source | archive filename |
| Catalog label | ics |
| Archive filename | ics.zip |
| File size | 1.4 MB |
| Author | font><font color (catalog-only claim) |
...
| Catalog author | font><font color |
...
- Local mirrored archive: [files/aol/aol-4-0/0955-ics.zip](../../../../../files/aol/aol-4-0/0955-ics.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ics.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ics.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ics.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ics.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ics.zip)
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | i can't scroll | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/ics.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/ics.zip) | [http://lenshellarchive.com/Progs/aolprogs/ics.zip](http://lenshellarchive.com/Progs/aolprogs/ics.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell misc progs A-M | ics.zip | [http://lenshellarchive.com/Progs/aolprogs/ics.zip](http://lenshellarchive.com/Progs/aolprogs/ics.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/ics.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/ics.zip) | unknown | http-404 |
