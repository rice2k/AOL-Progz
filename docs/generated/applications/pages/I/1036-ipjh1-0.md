...
| Field | Value |
| --- | --- |
| Archive ID | prog-1036-ipjh1-0 |
| Catalog number | 1036 |
| Best known name | IPJH1.0 |
| Best name source | catalog |
| Catalog label | IPJH1.0 |
| Archive filename | iphj.zip |
| File size | 1.5 MB |
| Author | aShcan |
...
| Catalog author | aShcan |
| Manual author evidence | unknown |
| Archive-text author | aShcan |
...
| Archive-text URL clues | [http://xxx.xx.xx](http://xxx.xx.xx)<br>[http://www.chaotic-code.com](http://www.chaotic-code.com) |
...
- Local mirrored archive: [files/aol/mixed/1036-ipjh1-0.zip](../../../../../files/aol/mixed/1036-ipjh1-0.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/iphj.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/iphj.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/iphj.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/iphj.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/iphj.zip)
...
| URL | Found in | Source |
| --- | --- | --- |
| [http://xxx.xx.xx](http://xxx.xx.xx) | README.txt | archive text |
| [http://www.chaotic-code.com](http://www.chaotic-code.com) | README.txt | archive text |
...
| --- | --- | --- | --- | --- | --- | --- |
| README.txt | aShcan (README.txt) | AOL/AIM chat utility | none | none | [http://xxx.xx.xx](http://xxx.xx.xx)<br>[http://www.chaotic-code.com](http://www.chaotic-code.com) | README.txt includes archive-text author clue(s): aShcan.<br>README.txt has vocabulary for AOL/AIM chat utility. |
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | internet protocol highjacker | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/iphj.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/iphj.zip) | [http://lenshellarchive.com/Progs/aolprogs/iphj.zip](http://lenshellarchive.com/Progs/aolprogs/iphj.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell misc progs A-M | iphj.zip | [http://lenshellarchive.com/Progs/aolprogs/iphj.zip](http://lenshellarchive.com/Progs/aolprogs/iphj.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/iphj.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/iphj.zip) | unknown | http-404 |
