...
| Field | Value |
| --- | --- |
| Archive ID | prog-0939-i-can-scan-by-jake |
| Catalog number | 939 |
| Best known name | i can scan by jake |
| Best name source | catalog |
| Catalog label | i can scan by jake |
| Archive filename | icanscan.zip |
| File size | 2.6 MB |
| Author | jake (catalog-only claim) |
...
- Local mirrored archive: [files/aol/aol-4-0/0939-i-can-scan-by-jake.zip](../../../../../files/aol/aol-4-0/0939-i-can-scan-by-jake.zip)
- Old-web / Wayback download leads: not matched yet
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/icanscan.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/icanscan.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/icanscan.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/icanscan.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/icanscan.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| aciddr0p.netReadMe2.txt<br>Read me.txt | none | none | none | none | none | aciddr0p.netReadMe2.txt includes a mirror/download-source note. |
