...
| Field | Value |
| --- | --- |
| Archive ID | prog-0593-dn-alpha-idle-v4 |
| Catalog number | 593 |
| Best known name | dn alpha-idle v4 |
| Best name source | catalog |
| Catalog label | dn alpha-idle v4 |
| Archive filename | dnalphav4.zip |
| File size | 5.5 MB |
| Author | bowzer |
...
| Archive text files reviewed | webtweek.reg<br>dn alpha-idle v4/webtweek.reg<br>aciddr0p.netReadMe.txt |
...
- Local mirrored archive: [files/aol/aol-4-0/0593-dn-alpha-idle-v4.zip](../../../../../files/aol/aol-4-0/0593-dn-alpha-idle-v4.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/dnalphav4.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/dnalphav4.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/dnalphav4.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/dnalphav4.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/dnalphav4.zip)
...
| --- | --- | --- | --- | --- |
| webtweek.reg<br>dn alpha-idle v4/webtweek.reg<br>aciddr0p.netReadMe.txt | none | none | none | aciddr0p.netReadMe.txt includes a mirror/download-source note. |
