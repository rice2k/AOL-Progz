...
| Field | Value |
| --- | --- |
| Archive ID | prog-0604-dotsetup |
| Catalog number | 604 |
| Best known name | dotsetup |
| Best name source | catalog |
| Catalog label | dotsetup |
| Archive filename | dotsetup.zip |
| File size | 886 KB |
| Author | unknown |
...
- Local mirrored archive: [files/aol/mixed/0604-dotsetup.zip](../../../../../files/aol/mixed/0604-dotsetup.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/dotsetup.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/dotsetup.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/dotsetup.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/dotsetup.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/dotsetup.zip)
...
| --- | --- | --- | --- |
| LensHell faders | dot fader | [https://web.archive.org/web/20110904002536/http://lenshellarchive.com/Progs/aolfaders/dotsetup.zip](https://web.archive.org/web/20110904002536/http://lenshellarchive.com/Progs/aolfaders/dotsetup.zip) | [http://lenshellarchive.com/Progs/aolfaders/dotsetup.zip](http://lenshellarchive.com/Progs/aolfaders/dotsetup.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell faders | dotsetup.zip | [http://lenshellarchive.com/Progs/aolfaders/dotsetup.zip](http://lenshellarchive.com/Progs/aolfaders/dotsetup.zip) | [https://web.archive.org/web/20110904002536/http://lenshellarchive.com/Progs/aolfaders/dotsetup.zip](https://web.archive.org/web/20110904002536/http://lenshellarchive.com/Progs/aolfaders/dotsetup.zip) | unknown | http-404 |
