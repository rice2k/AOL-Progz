...
| Field | Value |
| --- | --- |
| Archive ID | prog-0564-devis73 |
| Catalog number | 564 |
| Best known name | Devistation Online |
| Best name source | archive filename |
| Catalog label | DEVIS~73 |
| Archive filename | devistation_online_by_eraser.zip |
| File size | 1.0 MB |
| Author | Eraser |
...
| Catalog author | Eraser |
| Manual author evidence | unknown |
| Archive-text author | unknown |
| External ZIP text authors | unknown |
| Inferred author | Eraser |
...
- Local mirrored archive: [files/aol/aol-3-0/0564-devis73.zip](../../../../../files/aol/aol-3-0/0564-devis73.zip)
- Old-web / Wayback download leads: not matched yet
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/3.0/devistation_online_by_eraser.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/3.0/devistation_online_by_eraser.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/3.0/devistation_online_by_eraser.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/3.0/devistation_online_by_eraser.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/3.0/devistation_online_by_eraser.zip)
