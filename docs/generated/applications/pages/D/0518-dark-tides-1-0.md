...
| Field | Value |
| --- | --- |
| Archive ID | prog-0518-dark-tides-1-0 |
| Catalog number | 518 |
| Best known name | DARK TIDES 1.0 |
| Best name source | catalog |
| Catalog label | DARK TIDES 1.0 |
| Archive filename | darktides.zip |
| File size | 564 KB |
| Author | Monkey (catalog-only claim) |
...
- Local mirrored archive: [files/aol/aol-5-0/0518-dark-tides-1-0.zip](../../../../../files/aol/aol-5-0/0518-dark-tides-1-0.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/5.0/darktides.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/5.0/darktides.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/5.0/darktides.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/5.0/darktides.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/5.0/darktides.zip)
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | dark tides 1.0 | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/darktides.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/darktides.zip) | [http://lenshellarchive.com/Progs/aolprogs/darktides.zip](http://lenshellarchive.com/Progs/aolprogs/darktides.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: prog's/misc a-m | darktides.zip | [http://lenshellarchive.com/Progs/aolprogs/darktides.zip](http://lenshellarchive.com/Progs/aolprogs/darktides.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/darktides.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/darktides.zip) | unknown | http-404 |
