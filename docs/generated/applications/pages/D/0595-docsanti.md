...
| Field | Value |
| --- | --- |
| Archive ID | prog-0595-docsanti |
| Catalog number | 595 |
| Best known name | DocsAnti |
| Best name source | catalog |
| Catalog label | DocsAnti |
| Archive filename | docs anti.zip |
| File size | 1.0 MB |
| Author | DoC (catalog-only claim) |
...
- Local mirrored archive: [files/aol/aol-4-0/0595-docsanti.zip](../../../../../files/aol/aol-4-0/0595-docsanti.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/docs anti.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/docs%20anti.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/docs%20anti.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/docs%20anti.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/docs%20anti.zip)
