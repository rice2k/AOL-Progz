...
The catalog metadata and filename do not identify a confident single function yet. These need readme/source review or isolated inspection. Readable archive text also suggests: Fader / text styler, Punter / booter, Mass mailer / server, Account / TOS utility, Source / developer file, AOL/AIM chat utility.
...
| Platform | AOL |
| AOL/version bucket | AOL 4.0; archive text: AOL 4.0, AOL 95, AOL 2.5, AOL 3.0, AOL 4.5 |
...
Readable archive text also mentions: **AOL 4.0, AOL 95, AOL 2.5, AOL 3.0, AOL 4.5**.
