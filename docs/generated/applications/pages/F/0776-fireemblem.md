...
| --- | --- | --- | --- | --- | --- | --- |
| ST4UNST.LOG<br>Options Read!!!!!!.txt | none | Source / developer file<br>AOL/AIM chat utility | none | %% It will be used to automatically remove all application components from your computer if you choose to do so. %%<br>(File was not found or was an older version -- new file copied) | none | ST4UNST.LOG has vocabulary for Source / developer file.<br>Options Read!!!!!!.txt has vocabulary for AOL/AIM chat utility. |
