...
| Field | Value |
| --- | --- |
| Archive ID | prog-2044-wizard |
| Catalog number | 2044 |
| Best known name | Wizardz Punt 4.0 |
| Best name source | archive filename |
| Catalog label | wizard |
| Archive filename | wizardz punt 4.0 for aol 4.0.zip |
| File size | 22 B |
| Author | unknown |
...
- Original source path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/wizardz punt 4.0 for aol 4.0.zip`
