...
The catalog metadata and filename do not identify a confident single function yet. These need readme/source review or isolated inspection. Readable archive text also suggests: Media / file utility, AOL/AIM chat utility.
...
| Field | Value |
| --- | --- |
| Archive ID | prog-1584-rattrap |
| Catalog number | 1584 |
| Best known name | RatTrap |
| Best name source | catalog |
| Catalog label | RatTrap |
| Archive filename | rattrap.zip |
| File size | 1.4 MB |
| Author | Rylan (catalog-only claim) |
...
| Archive-text URL clues | [http://WWW.RYLAN.TK](http://WWW.RYLAN.TK) |
...
- Local mirrored archive: [files/aol/aol-4-0/1584-rattrap.zip](../../../../../files/aol/aol-4-0/1584-rattrap.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rattrap.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rattrap.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rattrap.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rattrap.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rattrap.zip)
...
| URL | Found in | Source |
| --- | --- | --- |
| [http://www.rylan.tk](http://www.rylan.tk) | Info.txt | archive text |
...
| --- | --- | --- | --- | --- | --- | --- |
| Info.txt | none | Media / file utility<br>AOL/AIM chat utility | none | none | [http://WWW.RYLAN.TK](http://WWW.RYLAN.TK) | Info.txt has vocabulary for Media / file utility, AOL/AIM chat utility. |
...
| --- | --- | --- | --- |
| LensHell misc progs N-Z | rat trap | [https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/rattrap.zip](https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/rattrap.zip) | [http://lenshellarchive.com/Progs/aolprogs/rattrap.zip](http://lenshellarchive.com/Progs/aolprogs/rattrap.zip) |
