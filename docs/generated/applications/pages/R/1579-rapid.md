...
| Field | Value |
| --- | --- |
| Archive ID | prog-1579-rapid |
| Catalog number | 1579 |
| Best known name | Rapid |
| Best name source | archive filename |
| Catalog label | Rapid |
| Archive filename | rapid.zip |
| File size | 2.0 MB |
| Author | unknown |
...
- Local mirrored archive: [files/aol/aol-4-0/1579-rapid.zip](../../../../../files/aol/aol-4-0/1579-rapid.zip)
- Old-web / Wayback download leads: 2 link(s) listed below
- Matched mirror leads: 2 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rapid.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rapid.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rapid.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rapid.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/rapid.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| READ ME.txt | none | Source / developer file | none | none | [http://solo.abac.com/dllarchive/](http://solo.abac.com/dllarchive/) | READ ME.txt has vocabulary for Source / developer file. |
