...
| Field | Value |
| --- | --- |
| Archive ID | prog-1474-polski-coms |
| Catalog number | 1474 |
| Best known name | Polski Coms |
| Best name source | catalog |
| Catalog label | Polski Coms |
| Archive filename | polskicomz.zip |
| File size | 4.9 MB |
| Author | Qremlin (catalog-only claim) |
...
| Archive text files reviewed | intro.txt<br>info.ini |
...
- Local mirrored archive: [files/aol/aol-4-0/1474-polski-coms.zip](../../../../../files/aol/aol-4-0/1474-polski-coms.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/polskicomz.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/polskicomz.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/polskicomz.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/polskicomz.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/polskicomz.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| intro.txt<br>info.ini | none | All-in-one prog suite | none | none | none | info.ini has vocabulary for All-in-one prog suite. |
...
| --- | --- | --- | --- |
| LensHell c-coms | polski comz | [https://web.archive.org/web/20110904002924/http://lenshellarchive.com/Progs/aolccoms/polskicomz.zip](https://web.archive.org/web/20110904002924/http://lenshellarchive.com/Progs/aolccoms/polskicomz.zip) | [http://lenshellarchive.com/Progs/aolccoms/polskicomz.zip](http://lenshellarchive.com/Progs/aolccoms/polskicomz.zip) |
