...
| Field | Value |
| --- | --- |
| Archive ID | prog-1404-passproc |
| Catalog number | 1404 |
| Best known name | passproc |
| Best name source | catalog |
| Catalog label | passproc |
| Archive filename | pass.proc private version aol8.zip |
| File size | 2.8 MB |
| Author | CAM0 (catalog-only claim) |
...
| Archive-text description clues | Make sure you have downloaded America online version 8.0<br>If you want this program to work right, you better not |
| Archive-text URL clues | unknown |
| External ZIP text purpose clues | unknown |
| Archive text files reviewed | instruction.txt<br>ports.lst<br>hosts.lst<br>aciddr0p.netReadMe.txt |
...
- Local mirrored archive: [files/aol/aol-4-0/1404-passproc.zip](../../../../../files/aol/aol-4-0/1404-passproc.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/pass.proc private version aol8.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/pass.proc%20private%20version%20aol8.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/pass.proc%20private%20version%20aol8.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/pass.proc%20private%20version%20aol8.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/pass.proc%20private%20version%20aol8.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| instruction.txt<br>ports.lst<br>hosts.lst<br>aciddr0p.netReadMe.txt | none | none | none | Make sure you have downloaded America online version 8.0<br>If you want this program to work right, you better not | none | aciddr0p.netReadMe.txt includes a mirror/download-source note. |
