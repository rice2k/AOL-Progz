# PoA AoL Notify remover final beta 6
...
| Field | Value |
| --- | --- |
| Archive ID | prog-1468-poa-aol-notify-remover-final-beta-6 |
| Catalog number | 1468 |
| Best known name | PoA AoL Notify remover final beta 6 |
| Best name source | catalog |
| Catalog label | PoA AoL Notify remover final beta 6 |
| Archive filename | poa3beta6.zip |
| File size | 65 KB |
| Author | PAT or JK (catalog-only claim) |
