...
| Field | Value |
| --- | --- |
| Archive ID | prog-1486-poslinkfinal |
| Catalog number | 1486 |
| Best known name | poslinkfinal |
| Best name source | catalog |
| Catalog label | poslinkfinal |
| Archive filename | posfinal.zip |
| File size | 1.4 MB |
| Author | unknown |
...
- Original source path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/posfinal.zip`
- Source repository URL: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/posfinal.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/posfinal.zip)
...
| URL | Found in | Source |
| --- | --- | --- |
| [http://busyonline.cjb.net](http://busyonline.cjb.net) | poslinkfinal.exe | archive text |
