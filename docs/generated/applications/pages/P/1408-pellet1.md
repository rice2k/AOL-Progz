...
| File size | 405 KB |
| Author | pelle (catalog-only claim) |
...
| Archive-text URL clues | [http://www.flufffycow.interspeed.net](http://www.flufffycow.interspeed.net)<br>[http://www.pureleetness.net](http://www.pureleetness.net) |
| External ZIP text purpose clues | unknown |
| Archive text files reviewed | Flufffycow.txt<br>Read Me.txt |
...
- Local mirrored archive: [files/aol/aol-4-0/1408-pellet1.zip](../../../../../files/aol/aol-4-0/1408-pellet1.zip)
- Old-web / Wayback download leads: 3 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/pelle.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/pelle.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/pelle.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| Flufffycow.txt<br>Read Me.txt | none | Media / file utility | none | none | [http://www.flufffycow.interspeed.net](http://www.flufffycow.interspeed.net)<br>[http://www.pureleetness.net](http://www.pureleetness.net) | Read Me.txt has vocabulary for Media / file utility. |
...
| Click here if you get a message saying download server busy, then try the same link on the next page of the file you are trying to download! | Pelle Toolz | [https://web.archive.org/web/20010623202957/http://24.185.191.87/progz/pelle.zip](https://web.archive.org/web/20010623202957/http://24.185.191.87/progz/pelle.zip) | [http://24.185.191.87/progz/pelle.zip](http://24.185.191.87/progz/pelle.zip) |
