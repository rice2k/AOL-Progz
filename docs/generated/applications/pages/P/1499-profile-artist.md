...
| Field | Value |
| --- | --- |
| Archive ID | prog-1499-profile-artist |
| Catalog number | 1499 |
| Best known name | Profile Artist |
| Best name source | catalog |
| Catalog label | Profile Artist |
| Archive filename | profileartist.zip |
| File size | 1.7 MB |
| Author | PAtrick A Cambria (catalog-only claim) |
...
| Catalog author | PAtrick A Cambria |
...
| Archive-text description clues | Description: Add graphics to AOL profiles that far exceed the standard text lenght of AOL's defaults. Tons of predefined Macros that are 100% editable. Also a neat scrolling spiral text feature.<br>Requirments: AOL 9.0 was the only Version of AOL tested with this program and I doubt any other versions will work 100% as expected. |
...
- Local mirrored archive: [files/aol/aol-4-0/1499-profile-artist.zip](../../../../../files/aol/aol-4-0/1499-profile-artist.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/profileartist.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/profileartist.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/profileartist.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/profileartist.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/profileartist.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| Read Me.txt | none | AOL/AIM chat utility | AOL 9.0 | Description: Add graphics to AOL profiles that far exceed the standard text lenght of AOL's defaults. Tons of predefined Macros that are 100% editable. Also a neat scrolling spiral text feature.<br>Requirments: AOL 9.0 was the only Version of AOL tested with this program and I doubt any other versions will work 100% as expected. | none | Read Me.txt mentions AOL 9.0.<br>Read Me.txt has vocabulary for AOL/AIM chat utility. |
...
| --- | --- | --- | --- |
| LensHell misc progs N-Z | profile artist beta | [https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/profileartist.zip](https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/profileartist.zip) | [http://lenshellarchive.com/Progs/aolprogs/profileartist.zip](http://lenshellarchive.com/Progs/aolprogs/profileartist.zip) |
