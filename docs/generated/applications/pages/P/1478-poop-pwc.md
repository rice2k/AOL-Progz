...
| Archive text files reviewed | aciddr0p.netReadMe2.txt<br>README.txt |
...
| --- | --- | --- | --- | --- |
| aciddr0p.netReadMe2.txt<br>README.txt | none | none | none | aciddr0p.netReadMe2.txt includes a mirror/download-source note. |
