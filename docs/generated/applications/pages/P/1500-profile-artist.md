...
| File size | 2.8 MB |
| Author | patorjk (catalog-only claim) |
...
| Archive-text description clues | Requirments: AOL 9.0 was the only Version of AOL tested with this program and I doubt any other versions will work 100% as expected. |
...
| --- | --- | --- | --- | --- | --- | --- |
| Read Me.txt | none | Fader / text styler<br>Source / developer file<br>AOL/AIM chat utility | AOL 9.0 | Requirments: AOL 9.0 was the only Version of AOL tested with this program and I doubt any other versions will work 100% as expected. | none | Read Me.txt mentions AOL 9.0.<br>Read Me.txt has vocabulary for Fader / text styler, Source / developer file, AOL/AIM chat utility. |
