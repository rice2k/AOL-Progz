...
| Field | Value |
| --- | --- |
| Archive ID | prog-1480-pork-n-ass-1-0 |
| Catalog number | 1480 |
| Best known name | Pork 'n' Ass 1.0 |
| Best name source | catalog |
| Catalog label | Pork 'n' Ass 1.0 |
| Archive filename | porknass.zip |
| File size | 188 KB |
| Author | ImMOrTaL (catalog-only claim) |
...
| Archive-text description clues | Thanks for downloading this program, Its a waste of space, But its funny<br>I hope you can enjoy SOME of the features.. Nothing like you would want |
...
- Local mirrored archive: [files/aol/aol-4-0/1480-pork-n-ass-1-0.zip](../../../../../files/aol/aol-4-0/1480-pork-n-ass-1-0.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/porknass.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/porknass.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/porknass.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/porknass.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/porknass.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| Read me.txt | none | AOL/AIM chat utility | none | Thanks for downloading this program, Its a waste of space, But its funny<br>I hope you can enjoy SOME of the features.. Nothing like you would want | none | Read me.txt has vocabulary for AOL/AIM chat utility. |
...
| --- | --- | --- | --- |
| LensHell misc progs N-Z | pork 'n' ass 1.0 | [https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/porknass.zip](https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/porknass.zip) | [http://lenshellarchive.com/Progs/aolprogs/porknass.zip](http://lenshellarchive.com/Progs/aolprogs/porknass.zip) |
