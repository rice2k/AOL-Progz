...
| Catalog number | 1550 |
| Best known name | PWSD Scanner by Spazz |
| Best name source | catalog |
| Catalog label | PWSD Scanner by Spazz |
| Archive filename | spazz2k.zip |
| File size | unknown |
| Author | Spazz |
...
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/spazz2k.zip`
