...
| Manual review flags | author unknown, category uncertain, main local file missing, no screenshot or image lead, no readable text evidence |
...
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/str8upfake.zip`
