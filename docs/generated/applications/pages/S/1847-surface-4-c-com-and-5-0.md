# Surface 4 C-Com And 5.0

Catalog label: **surface**.
...
| Field | Value |
| --- | --- |
| Archive ID | prog-1847-surface |
| Catalog number | 1847 |
| Best known name | Surface 4 C-Com And 5.0 |
| Best name source | archive filename |
| Catalog label | surface |
| Archive filename | surface4 c-com for aol 4.0 and 5.0.zip |
| File size | 22 B |
| Author | unknown |
...
- Original source path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/surface4 c-com for aol 4.0 and 5.0.zip`
