...
| Field | Value |
| --- | --- |
| Archive ID | prog-2055-x-i-x-ower |
| Catalog number | 2055 |
| Best known name | X î X ówèr |
| Best name source | catalog |
| Catalog label | X î X ówèr |
| Archive filename | xixpower.zip |
| File size | unknown |
| Author | ReapeR aka carnage (catalog-only claim) |
...
| Catalog author | ReapeR aka carnage |
...
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/xixpower.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/xixpower.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/xixpower.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/xixpower.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/xixpower.zip)
...
| --- | --- | --- | --- |
| LensHell misc progs N-Z | x i x power | [https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/xixpower.zip](https://web.archive.org/web/20110904003557/http://lenshellarchive.com/Progs/aolprogs/xixpower.zip) | [http://lenshellarchive.com/Progs/aolprogs/xixpower.zip](http://lenshellarchive.com/Progs/aolprogs/xixpower.zip) |
