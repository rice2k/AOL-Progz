...
| --- | --- | --- | --- | --- | --- | --- |
| leanme.txt<br>aciddr0p.netReadMe.txt | none | AOL/AIM chat utility | AOL 7.0<br>AOL 9.1 | none | none | leanme.txt mentions AOL 7.0, AOL 9.1.<br>leanme.txt has vocabulary for AOL/AIM chat utility.<br>aciddr0p.netReadMe.txt includes a mirror/download-source note. |
