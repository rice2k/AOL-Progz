...
| Field | Value |
| --- | --- |
| Archive ID | prog-0879-hakkor-ip-stealer |
| Catalog number | 879 |
| Best known name | hakkor ip stealer |
| Best name source | catalog |
| Catalog label | hakkor ip stealer |
| Archive filename | hakkoripstealer.zip |
| File size | 1.9 MB |
| Author | Hakkor |
| Catalog author | Hakkor |
...
- Local mirrored archive: [files/aol/mixed/0879-hakkor-ip-stealer.zip](../../../../../files/aol/mixed/0879-hakkor-ip-stealer.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hakkoripstealer.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hakkoripstealer.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hakkoripstealer.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hakkoripstealer.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hakkoripstealer.zip)
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | hakkor ip stealer | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/hakkoripstealer.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/hakkoripstealer.zip) | [http://lenshellarchive.com/Progs/aolprogs/hakkoripstealer.zip](http://lenshellarchive.com/Progs/aolprogs/hakkoripstealer.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell misc progs A-M | hakkoripstealer.zip | [http://lenshellarchive.com/Progs/aolprogs/hakkoripstealer.zip](http://lenshellarchive.com/Progs/aolprogs/hakkoripstealer.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/hakkoripstealer.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/hakkoripstealer.zip) | unknown | http-404 |
