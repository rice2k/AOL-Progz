...
| Field | Value |
| --- | --- |
| Archive ID | prog-0922-html-grabber |
| Catalog number | 922 |
| Best known name | html grabber |
| Best name source | catalog |
| Catalog label | html grabber |
| Archive filename | htmlgrabber.zip |
| File size | 2.0 MB |
| Author | trip |
...
| Archive-text description clues | description: grabs html from webpages. |
| Archive-text URL clues | [http://www.trips-playground.com](http://www.trips-playground.com) |
| External ZIP text purpose clues | unknown |
| Archive text files reviewed | Read.txt<br>Help.txt |
...
- Local mirrored archive: [files/aol/mixed/0922-html-grabber.zip](../../../../../files/aol/mixed/0922-html-grabber.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/htmlgrabber.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/htmlgrabber.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/htmlgrabber.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/htmlgrabber.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/htmlgrabber.zip)
...
| URL | Found in | Source |
| --- | --- | --- |
| [http://www.trips-playground.com](http://www.trips-playground.com) | Read.txt | archive text |
...
| --- | --- | --- | --- | --- | --- | --- |
| Read.txt<br>Help.txt | trip (Read.txt) | Source / developer file | none | description: grabs html from webpages. | [http://www.trips-playground.com](http://www.trips-playground.com) | Read.txt includes archive-text author clue(s): trip.<br>Read.txt has vocabulary for Source / developer file. |
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | html grabber | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/htmlgrabber.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/htmlgrabber.zip) | [http://lenshellarchive.com/Progs/aolprogs/htmlgrabber.zip](http://lenshellarchive.com/Progs/aolprogs/htmlgrabber.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell misc progs A-M | htmlgrabber.zip | [http://lenshellarchive.com/Progs/aolprogs/htmlgrabber.zip](http://lenshellarchive.com/Progs/aolprogs/htmlgrabber.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/htmlgrabber.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/htmlgrabber.zip) | unknown | http-404 |
