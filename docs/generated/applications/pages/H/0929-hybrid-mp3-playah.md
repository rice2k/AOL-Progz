...
| Field | Value |
| --- | --- |
| Archive ID | prog-0929-hybrid-mp3-playah |
| Catalog number | 929 |
| Best known name | hybriD mp3 playah |
| Best name source | catalog |
| Catalog label | hybriD mp3 playah |
| Archive filename | hybridmp3.zip |
| File size | 3.3 MB |
| Author | champs (catalog-only claim) |
...
- Local mirrored archive: [files/aol/mixed/0929-hybrid-mp3-playah.zip](../../../../../files/aol/mixed/0929-hybrid-mp3-playah.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hybridmp3.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hybridmp3.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hybridmp3.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hybridmp3.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/hybridmp3.zip)
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | hybrid mp3 playah | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/hybridmp3.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/hybridmp3.zip) | [http://lenshellarchive.com/Progs/aolprogs/hybridmp3.zip](http://lenshellarchive.com/Progs/aolprogs/hybridmp3.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell misc progs A-M | hybridmp3.zip | [http://lenshellarchive.com/Progs/aolprogs/hybridmp3.zip](http://lenshellarchive.com/Progs/aolprogs/hybridmp3.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/hybridmp3.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/hybridmp3.zip) | unknown | http-404 |
