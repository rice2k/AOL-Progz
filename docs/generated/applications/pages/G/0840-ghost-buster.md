...
| Field | Value |
| --- | --- |
| Archive ID | prog-0840-ghost-buster |
| Catalog number | 840 |
| Best known name | ghost buster |
| Best name source | catalog |
| Catalog label | ghost buster |
| Archive filename | ghostbuster.zip |
| File size | 2.0 MB |
| Author | smut (catalog-only claim) |
...
- Local mirrored archive: [files/aol/aol-4-0/0840-ghost-buster.zip](../../../../../files/aol/aol-4-0/0840-ghost-buster.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ghostbuster.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ghostbuster.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ghostbuster.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ghostbuster.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ghostbuster.zip)
