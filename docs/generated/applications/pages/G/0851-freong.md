...
| Field | Value |
| --- | --- |
| Archive ID | prog-0851-gold |
| Catalog number | 851 |
| Best known name | Freong |
| Best name source | archive filename |
| Catalog label | Gold |
| Archive filename | freong.zip |
| File size | 2.7 MB |
...
| Archive text files reviewed | ST5UNST.LOG |
...
| --- | --- | --- | --- | --- | --- | --- |
| ST5UNST.LOG | none | Source / developer file | none | %% It will be used to automatically remove all application components from your computer if you choose to do so. %%<br>(File was not found or was an older version -- new file copied) | none | ST5UNST.LOG has vocabulary for Source / developer file. |
