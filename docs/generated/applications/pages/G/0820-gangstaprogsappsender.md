# GangstaProgsAppsender



The catalog metadata and filename do not identify a confident single function yet. These need readme/source review or isolated inspection. Readable archive text also suggests: Fader / text styler, Source / developer file.
...
| Field | Value |
| --- | --- |
| Archive ID | prog-0820-gangstaprogsappsender |
| Catalog number | 820 |
| Best known name | GangstaProgsAppsender |
| Best name source | catalog |
| Catalog label | GangstaProgsAppsender |
| Archive filename | gangstaapp.zip |
| File size | 2.3 MB |
| Author | BigAl (catalog-only claim) |
...
| Archive-text URL clues | [http://www.gangstaprogs.cjb.net](http://www.gangstaprogs.cjb.net) |
...
| URL | Found in | Source |
| --- | --- | --- |
| [http://www.gangstaprogs.cjb.net](http://www.gangstaprogs.cjb.net) | Readme.doc | archive text |
...
| --- | --- | --- | --- | --- | --- | --- |
| Readme.doc | none | Fader / text styler<br>Source / developer file | none | none | [http://www.gangstaprogs.cjb.net](http://www.gangstaprogs.cjb.net) | Readme.doc has vocabulary for Fader / text styler, Source / developer file. |
