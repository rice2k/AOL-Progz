...
| Field | Value |
| --- | --- |
| Archive ID | prog-0816-gagematec2 |
| Catalog number | 816 |
| Best known name | gagematec² |
| Best name source | catalog |
| Catalog label | gagematec² |
| Archive filename | gagematec 2 aol7-9 winALL yr04.zip |
| File size | 2.5 MB |
...
| Archive text files reviewed | gagematec�/need help opening.txt |
...
| --- | --- | --- | --- | --- | --- | --- |
| gagematec�/need help opening.txt | none | Source / developer file<br>Media / file utility<br>AOL/AIM chat utility | none | none | none | gagematec�/need help opening.txt has vocabulary for Source / developer file, Media / file utility, AOL/AIM chat utility. |
