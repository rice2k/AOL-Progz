...
| Field | Value |
| --- | --- |
| Archive ID | prog-0846-gmmb12 |
| Catalog number | 846 |
| Best known name | gmmb12 |
| Best name source | catalog |
| Catalog label | gmmb12 |
| Archive filename | goldmm.zip |
| File size | 572 KB |
| Author | unknown |
...
- Local mirrored archive: [files/aol/aol-4-0/0846-gmmb12.zip](../../../../../files/aol/aol-4-0/0846-gmmb12.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/goldmm.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/goldmm.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/goldmm.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/goldmm.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/goldmm.zip)
...
| --- | --- | --- | --- |
| LensHell mailers and servers | gold mmer | [https://web.archive.org/web/20110904062518/http://lenshellarchive.com/Progs/aolmmservers/goldmm.zip](https://web.archive.org/web/20110904062518/http://lenshellarchive.com/Progs/aolmmservers/goldmm.zip) | [http://lenshellarchive.com/Progs/aolmmservers/goldmm.zip](http://lenshellarchive.com/Progs/aolmmservers/goldmm.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell mailers and servers | goldmm.zip | [http://lenshellarchive.com/Progs/aolmmservers/goldmm.zip](http://lenshellarchive.com/Progs/aolmmservers/goldmm.zip) | [https://web.archive.org/web/20110904062518/http://lenshellarchive.com/Progs/aolmmservers/goldmm.zip](https://web.archive.org/web/20110904062518/http://lenshellarchive.com/Progs/aolmmservers/goldmm.zip) | unknown | http-404 |
