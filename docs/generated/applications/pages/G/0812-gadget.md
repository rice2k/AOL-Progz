...
| Field | Value |
| --- | --- |
| Archive ID | prog-0812-gadget |
| Catalog number | 812 |
| Best known name | Gadget |
| Best name source | catalog |
| Catalog label | Gadget |
| Archive filename | gadget.zip |
| File size | 4.4 MB |
| Author | kryo (catalog-only claim) |
...
| Archive-text URL clues | [http://www.hyper.hyperspage](http://www.hyper.hyperspage)<br>[http://www.angelfire.com/in2/hhyypper69](http://www.angelfire.com/in2/hhyypper69)<br>[http://terrorsquad.simplenet.com](http://terrorsquad.simplenet.com) |
...
| URL | Found in | Source |
| --- | --- | --- |
| [http://www.hyper.hyperspage](http://www.hyper.hyperspage) | solar/message from HyPeR.txt | archive text |
| [http://www.angelfire.com/in2/hhyypper69](http://www.angelfire.com/in2/hhyypper69) | solar/message from HyPeR.txt | archive text |
| [http://terrorsquad.simplenet.com](http://terrorsquad.simplenet.com) | READ THIS NOW!.txt | archive text |
...
| --- | --- | --- | --- | --- | --- | --- |
| solar/message from HyPeR.txt<br>READ THIS NOW!.txt | none | All-in-one prog suite | none | none | [http://www.hyper.hyperspage](http://www.hyper.hyperspage)<br>[http://www.angelfire.com/in2/hhyypper69](http://www.angelfire.com/in2/hhyypper69)<br>[http://terrorsquad.simplenet.com](http://terrorsquad.simplenet.com) | READ THIS NOW!.txt has vocabulary for All-in-one prog suite.<br>READ THIS NOW!.txt includes a mirror/download-source note. |
