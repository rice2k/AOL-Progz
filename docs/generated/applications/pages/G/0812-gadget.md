...
| --- | --- | --- | --- | --- |
| solar/message from HyPeR.txt<br>READ THIS NOW!.txt | none | All-in-one prog suite | none | READ THIS NOW!.txt has vocabulary for All-in-one prog suite.<br>READ THIS NOW!.txt includes a mirror/download-source note. |
