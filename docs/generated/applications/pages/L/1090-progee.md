...
| Field | Value |
| --- | --- |
| Archive ID | prog-1090-lag |
| Catalog number | 1090 |
| Best known name | Progee |
| Best name source | archive filename |
| Catalog label | Lag |
| Archive filename | progee.zip |
| File size | 780 KB |
| Author | unknown |
...
| Archive-text URL clues | [http://come.to/ThaAbbot](http://come.to/ThaAbbot) |
...
| URL | Found in | Source |
| --- | --- | --- |
| [http://come.to/ThaAbbot](http://come.to/ThaAbbot) | READ THIS FIRST!.txt | archive text |
...
| --- | --- | --- | --- | --- | --- | --- |
| READ THIS FIRST!.txt | none | none | none | none | [http://come.to/ThaAbbot](http://come.to/ThaAbbot) | unknown |
