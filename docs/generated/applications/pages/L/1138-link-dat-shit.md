...
The catalog metadata and filename do not identify a confident single function yet. These need readme/source review or isolated inspection. Filename/catalog cues suggest: linking/chat link workflows. Readable archive text also suggests: C-Com / command list, Linker / chat linker, Mass mailer / server, AOL/AIM chat utility.
...
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/linkdat.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/linkdat.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/linkdat.zip)
