...
| Field | Value |
| --- | --- |
| Archive ID | prog-1178-loz-del-mando |
| Catalog number | 1178 |
| Best known name | LoZ DeL MaNdO |
| Best name source | catalog |
| Catalog label | LoZ DeL MaNdO |
| Archive filename | lozdelmando.zip |
| File size | 1.5 MB |
| Author | unknown |
...
| Platform | AOL |
| AOL/version bucket | AOL 4.0; archive text: AOL 8.0, AOL 9.0 |
...
| Archive-text description clues | This program it work on aol 8.0-9.0 this program is made by the hands of ZzFzZ CaZaDoR so<br>is a program that work with 8.0-9.0 AOL and WINDOWS 2000 AND XP<br>it just work for AOL the type of prog is misc it just a scroller. |
...
- Local mirrored archive: [files/aol/aol-4-0/1178-loz-del-mando.zip](../../../../../files/aol/aol-4-0/1178-loz-del-mando.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/lozdelmando.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/lozdelmando.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/lozdelmando.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/lozdelmando.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/lozdelmando.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| !!!!!!ReaD Me!!!!!!!.txt | none | Scroller / macro | AOL 8.0<br>AOL 9.0 | This program it work on aol 8.0-9.0 this program is made by the hands of ZzFzZ CaZaDoR so<br>is a program that work with 8.0-9.0 AOL and WINDOWS 2000 AND XP<br>it just work for AOL the type of prog is misc it just a scroller. | none | !!!!!!ReaD Me!!!!!!!.txt mentions AOL 8.0, AOL 9.0.<br>!!!!!!ReaD Me!!!!!!!.txt has vocabulary for Scroller / macro. |
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | loz del mando | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/lozdelmando.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/lozdelmando.zip) | [http://lenshellarchive.com/Progs/aolprogs/lozdelmando.zip](http://lenshellarchive.com/Progs/aolprogs/lozdelmando.zip) |
