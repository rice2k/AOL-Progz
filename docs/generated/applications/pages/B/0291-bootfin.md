...
| Field | Value |
| --- | --- |
| Archive ID | prog-0291-bootfin |
| Catalog number | 291 |
| Best known name | BoOTFiN |
| Best name source | catalog |
| Catalog label | BoOTFiN |
| Archive filename | bootfin.zip |
| File size | 1.0 MB |
| Author | VE0V (catalog-only claim) |
...
- Local mirrored archive: [files/aol/aol-4-0/0291-bootfin.zip](../../../../../files/aol/aol-4-0/0291-bootfin.zip)
- Old-web / Wayback download leads: not matched yet
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/bootfin.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/bootfin.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/bootfin.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/bootfin.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/bootfin.zip)
