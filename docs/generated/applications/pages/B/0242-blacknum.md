...
| Field | Value |
| --- | --- |
| Archive ID | prog-0242-blacknum |
| Catalog number | 242 |
| Best known name | BlackNum |
| Best name source | catalog |
| Catalog label | BlackNum |
| Archive filename | blacknum.zip |
| File size | 729 KB |
| Author | DuKSiZ (catalog-only claim) |
...
- Local mirrored archive: [files/aol/aol-4-0/0242-blacknum.zip](../../../../../files/aol/aol-4-0/0242-blacknum.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/blacknum.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/blacknum.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/blacknum.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/blacknum.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/blacknum.zip)
