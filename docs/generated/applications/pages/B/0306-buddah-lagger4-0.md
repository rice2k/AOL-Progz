...
| Field | Value |
| --- | --- |
| Archive ID | prog-0306-buddah-lagger4-0 |
| Catalog number | 306 |
| Best known name | BuDDaH Lagger4.0 |
| Best name source | catalog |
| Catalog label | BuDDaH Lagger4.0 |
| Archive filename | buddahlagcom.zip |
| File size | 1.4 MB |
...
- Local mirrored archive: [files/aol/aol-4-0/0306-buddah-lagger4-0.zip](../../../../../files/aol/aol-4-0/0306-buddah-lagger4-0.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagcom.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagcom.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagcom.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagcom.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagcom.zip)
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | buddah lagger 4.0 | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/buddahlagcom.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/buddahlagcom.zip) | [http://lenshellarchive.com/Progs/aolprogs/buddahlagcom.zip](http://lenshellarchive.com/Progs/aolprogs/buddahlagcom.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: prog's/misc a-m | buddahlagcom.zip | [http://lenshellarchive.com/Progs/aolprogs/buddahlagcom.zip](http://lenshellarchive.com/Progs/aolprogs/buddahlagcom.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/buddahlagcom.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/buddahlagcom.zip) | unknown | http-404 |
