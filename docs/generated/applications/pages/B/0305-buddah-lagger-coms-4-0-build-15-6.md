# BuDDaH Lagger coms 4.0 build 15.6
...
| Field | Value |
| --- | --- |
| Archive ID | prog-0305-buddah-lagger-coms-4-0-build-15-6 |
| Catalog number | 305 |
| Best known name | BuDDaH Lagger coms 4.0 build 15.6 |
| Best name source | catalog |
| Catalog label | BuDDaH Lagger coms 4.0 build 15.6 |
| Archive filename | buddahlagger4.zip |
| File size | 2.8 MB |
| Author | BuDDaH (catalog-only claim) |
...
| Archive text files reviewed | aciddr0p.netReadMe2.txt<br>aciddr0p.netReadMe.txt |
...
- Local mirrored archive: [files/aol/aol-4-0/0305-buddah-lagger-coms-4-0-build-15-6.zip](../../../../../files/aol/aol-4-0/0305-buddah-lagger-coms-4-0-build-15-6.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagger4.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagger4.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagger4.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagger4.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/buddahlagger4.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| aciddr0p.netReadMe2.txt<br>aciddr0p.netReadMe.txt | none | none | none | none | none | aciddr0p.netReadMe2.txt includes a mirror/download-source note.<br>aciddr0p.netReadMe.txt includes a mirror/download-source note. |
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | buddah lagger coms 4.0 build 15.6 | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/blc40156.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/blc40156.zip) | [http://lenshellarchive.com/Progs/aolprogs/blc40156.zip](http://lenshellarchive.com/Progs/aolprogs/blc40156.zip) |
