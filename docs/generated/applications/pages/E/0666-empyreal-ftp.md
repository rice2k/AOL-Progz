...
| Field | Value |
| --- | --- |
| Archive ID | prog-0666-empyreal-ftp |
| Catalog number | 666 |
| Best known name | empyreal ftp |
| Best name source | catalog |
| Catalog label | empyreal ftp |
| Archive filename | empyrealftp.zip |
| File size | 1.6 MB |
| Author | unknown |
...
- Local mirrored archive: [files/aol/mixed/0666-empyreal-ftp.zip](../../../../../files/aol/mixed/0666-empyreal-ftp.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/empyrealftp.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/empyrealftp.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/empyrealftp.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/empyrealftp.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/empyrealftp.zip)
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | empyreal ftp | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/empyrealftp.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/empyrealftp.zip) | [http://lenshellarchive.com/Progs/aolprogs/empyrealftp.zip](http://lenshellarchive.com/Progs/aolprogs/empyrealftp.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell misc progs A-M | empyrealftp.zip | [http://lenshellarchive.com/Progs/aolprogs/empyrealftp.zip](http://lenshellarchive.com/Progs/aolprogs/empyrealftp.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/empyrealftp.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/empyrealftp.zip) | unknown | http-404 |
