...
| File size | 1.6 MB |
| Author | Oxygen (catalog-only claim) |
...
| Archive-text description clues | aim version:I'm not gonna waist my time with that crap |
...
| --- | --- | --- | --- | --- | --- | --- |
| important(read).txt | none | AOL/AIM chat utility | none | aim version:I'm not gonna waist my time with that crap | none | important(read).txt has vocabulary for AOL/AIM chat utility. |
