...
| Archive text files reviewed | esmreadme.txt |
...
| --- | --- | --- | --- | --- |
| esmreadme.txt | none | Idler / AFK bot<br>AOL/AIM chat utility | none | esmreadme.txt has vocabulary for Idler / AFK bot, AOL/AIM chat utility. |
