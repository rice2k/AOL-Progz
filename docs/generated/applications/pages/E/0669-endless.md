...
| Field | Value |
| --- | --- |
| Archive ID | prog-0669-endless |
| Catalog number | 669 |
| Best known name | endless |
| Best name source | catalog |
| Catalog label | endless |
| Archive filename | endless.zip |
| File size | 1.3 MB |
| Author | unknown |
...
- Original source path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/endless.zip`
- Source repository URL: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/endless.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/endless.zip)
