# Emoties Win 2k-xp Yr 04

Catalog label: **EmoTies**.
...
| Field | Value |
| --- | --- |
| Archive ID | prog-0661-emoties |
| Catalog number | 661 |
| Best known name | Emoties Win 2k-xp Yr 04 |
| Best name source | archive filename |
| Catalog label | EmoTies |
| Archive filename | emoties aol8-9 win2k-xp yr04.zip |
| File size | 1.5 MB |
| Author | jogging (catalog-only claim) |
