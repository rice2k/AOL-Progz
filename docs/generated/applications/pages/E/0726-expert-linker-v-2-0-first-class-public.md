# Expert Linker V 2.0 First Class [public]

Catalog label: **exp2setupfc**.
...
| Field | Value |
| --- | --- |
| Archive ID | prog-0726-exp2setupfc |
| Catalog number | 726 |
| Best known name | Expert Linker V 2.0 First Class [public] |
| Best name source | archive filename |
| Catalog label | exp2setupfc |
| Archive filename | expert linker v2.0 first class [public] for aol 2.5-7.0.zip |
| File size | 2.1 MB |
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | expert linker v2.0 first class [public] | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/exp2setupfc.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/exp2setupfc.zip) | [http://lenshellarchive.com/Progs/aolprogs/exp2setupfc.zip](http://lenshellarchive.com/Progs/aolprogs/exp2setupfc.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell misc progs A-M | exp2setupfc.zip | [http://lenshellarchive.com/Progs/aolprogs/exp2setupfc.zip](http://lenshellarchive.com/Progs/aolprogs/exp2setupfc.zip) | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/exp2setupfc.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/exp2setupfc.zip) | unknown | http-404 |
