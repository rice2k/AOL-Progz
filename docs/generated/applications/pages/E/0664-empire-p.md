...
| Field | Value |
| --- | --- |
| Archive ID | prog-0664-empire-p |
| Catalog number | 664 |
| Best known name | Empire p│ |
| Best name source | catalog |
| Catalog label | Empire p│ |
| Archive filename | empirep3.zip |
| File size | 2.4 MB |
...
- Local mirrored archive: [files/aol/aol-4-0/0664-empire-p.zip](../../../../../files/aol/aol-4-0/0664-empire-p.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/empirep3.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/empirep3.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/empirep3.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/empirep3.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/empirep3.zip)
