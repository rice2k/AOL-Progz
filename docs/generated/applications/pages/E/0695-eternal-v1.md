...
| Field | Value |
| --- | --- |
| Archive ID | prog-0695-eternal-v1 |
| Catalog number | 695 |
| Best known name | Eternal v1 |
| Best name source | catalog |
| Catalog label | Eternal v1 |
| Archive filename | eternalv1.zip |
| File size | 1.6 MB |
...
- Local mirrored archive: [files/aol/aol-4-0/0695-eternal-v1.zip](../../../../../files/aol/aol-4-0/0695-eternal-v1.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Matched mirror leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/eternalv1.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/eternalv1.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/eternalv1.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/eternalv1.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/eternalv1.zip)
...
| --- | --- | --- | --- |
| LensHell busters | eternal v1 roombuster | [https://web.archive.org/web/20110906025742/http://lenshellarchive.com/Progs/aolbusters/eternalv1.zip](https://web.archive.org/web/20110906025742/http://lenshellarchive.com/Progs/aolbusters/eternalv1.zip) | [http://lenshellarchive.com/Progs/aolbusters/eternalv1.zip](http://lenshellarchive.com/Progs/aolbusters/eternalv1.zip) |

### Mirror Leads

| Source | Label | Original URL | Wayback URL | Local recovered file | Status |
| --- | --- | --- | --- | --- | --- |
| Web page: LensHell busters | eternalv1.zip | [http://lenshellarchive.com/Progs/aolbusters/eternalv1.zip](http://lenshellarchive.com/Progs/aolbusters/eternalv1.zip) | [https://web.archive.org/web/20110906025742/http://lenshellarchive.com/Progs/aolbusters/eternalv1.zip](https://web.archive.org/web/20110906025742/http://lenshellarchive.com/Progs/aolbusters/eternalv1.zip) | unknown | http-404 |
