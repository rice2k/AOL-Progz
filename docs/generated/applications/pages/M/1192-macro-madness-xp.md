...
A macro, ASCII art, canned-command, or repeated-text utility for chat/profile output. Filename/catalog cues suggest: scrolling, macros, or ASCII text. Readable archive text also suggests: Punter / booter.
...
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/madnessxp.zip`
