...
| Field | Value |
| --- | --- |
| Archive ID | prog-1305-mprztoolz |
| Catalog number | 1305 |
| Best known name | MprzToolz |
| Best name source | catalog |
| Catalog label | MprzToolz |
| Archive filename | mopar.zip |
| File size | 866 KB |
...
| Platform | AOL |
| AOL/version bucket | AOL 4.0; archive text: AOL 95, AOL 3.0 |
| Catalog AOL/version bucket | AOL 4.0 |
| Inferred AOL version | unknown |
| Archive-text AOL/version mentions | AOL 95, AOL 3.0 |
| External ZIP text version mentions | unknown |
| Prog type | All-in-one prog suite |
| Category | uncategorized |
| Manual purpose clues | unknown |
| Archive-text purpose clues | All-in-one prog suite, AOL/AIM chat utility |
| Archive-text description clues | on AOL3.0 16bit. This Version (v1.2) of MoPaRz Toolz has<br>did with version 1.0. Anyway, If u have a bug to report, |
...
- Local mirrored archive: [files/aol/aol-4-0/1305-mprztoolz.zip](../../../../../files/aol/aol-4-0/1305-mprztoolz.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mopar.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mopar.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mopar.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mopar.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mopar.zip)
...
Readable archive text also mentions: **AOL 95, AOL 3.0**.
...
| --- | --- | --- | --- | --- | --- | --- |
| Readme.txt | none | All-in-one prog suite<br>AOL/AIM chat utility | AOL 95<br>AOL 3.0 | on AOL3.0 16bit. This Version (v1.2) of MoPaRz Toolz has<br>did with version 1.0. Anyway, If u have a bug to report, | none | Readme.txt mentions AOL 95, AOL 3.0.<br>Readme.txt has vocabulary for All-in-one prog suite, AOL/AIM chat utility. |
...
| --- | --- | --- | --- |
| LensHell c-coms | moparz toolz 1.2 | [https://web.archive.org/web/20110904002924/http://lenshellarchive.com/Progs/aolccoms/mopar.zip](https://web.archive.org/web/20110904002924/http://lenshellarchive.com/Progs/aolccoms/mopar.zip) | [http://lenshellarchive.com/Progs/aolccoms/mopar.zip](http://lenshellarchive.com/Progs/aolccoms/mopar.zip) |
