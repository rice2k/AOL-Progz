...
| Field | Value |
| --- | --- |
| Archive ID | prog-1276-mirage-v1-o |
| Catalog number | 1276 |
| Best known name | Mirage v1.o |
| Best name source | catalog |
| Catalog label | Mirage v1.o |
| Archive filename | mirage.zip |
| File size | 4.1 MB |
...
| Archive-text URL clues | [http://aolprogs.simplenet.com](http://aolprogs.simplenet.com) |
| External ZIP text purpose clues | unknown |
| Archive text files reviewed | readme.txt<br>Download..txt |
...
- Local mirrored archive: [files/aol/aol-4-0/1276-mirage-v1-o.zip](../../../../../files/aol/aol-4-0/1276-mirage-v1-o.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mirage.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mirage.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mirage.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mirage.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/mirage.zip)
...
| URL | Found in | Source |
| --- | --- | --- |
| [http://aolprogs.simplenet.com](http://aolprogs.simplenet.com) | Download..txt | archive text |
...
| --- | --- | --- | --- | --- | --- | --- |
| readme.txt<br>Download..txt | none | Mass mailer / server | none | none | [http://aolprogs.simplenet.com](http://aolprogs.simplenet.com) | readme.txt has vocabulary for Mass mailer / server. |
...
| --- | --- | --- | --- |
| LensHell misc progs A-M | mirage 1.0 | [https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/mirage.zip](https://web.archive.org/web/20110904003253/http://lenshellarchive.com/Progs/aolprogs/mirage.zip) | [http://lenshellarchive.com/Progs/aolprogs/mirage.zip](http://lenshellarchive.com/Progs/aolprogs/mirage.zip) |
