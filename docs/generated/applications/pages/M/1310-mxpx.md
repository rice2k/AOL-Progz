...
| File size | 1.7 MB |
| Author | me, nes (catalog-only claim) |
...
| Archive-text description clues | please check out my site, it has lots of files to download for aol 4, |
| Archive-text URL clues | [http://nes2k.cjb.net](http://nes2k.cjb.net) |
...
| --- | --- | --- | --- | --- | --- | --- |
| about_mxpx.txt | none | C-Com / command list<br>Source / developer file<br>Media / file utility<br>AOL/AIM chat utility | AOL 4<br>AOL 5<br>AOL 3.0<br>AOL 2.5 | please check out my site, it has lots of files to download for aol 4, | [http://nes2k.cjb.net](http://nes2k.cjb.net) | about_mxpx.txt mentions AOL 4, AOL 5, AOL 3.0, AOL 2.5.<br>about_mxpx.txt has vocabulary for C-Com / command list, Source / developer file, Media / file utility, AOL/AIM chat utility. |
