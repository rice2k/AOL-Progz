...
| Field | Value |
| --- | --- |
| Archive ID | prog-1212-malevolent-creation |
| Catalog number | 1212 |
| Best known name | Malevolent Creation |
| Best name source | catalog |
| Catalog label | Malevolent Creation |
| Archive filename | malevolent.zip |
| File size | 1.4 MB |
| Author | s Realm is a tsp (catalog-only claim) |
...
| Archive text files reviewed | MorFeuS's ReaLM.txt |
...
- Local mirrored archive: [files/aol/aol-4-0/1212-malevolent-creation.zip](../../../../../files/aol/aol-4-0/1212-malevolent-creation.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/malevolent.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/malevolent.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/malevolent.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/malevolent.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/malevolent.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| MorFeuS's ReaLM.txt | none | AOL/AIM chat utility | none | none | [http://members.dencity.com/morfeus/index.html´`·.·´`](http://members.dencity.com/morfeus/index.html´`·.·´`) | MorFeuS's ReaLM.txt has vocabulary for AOL/AIM chat utility.<br>MorFeuS's ReaLM.txt includes a mirror/download-source note. |
...
| --- | --- | --- | --- |
| LensHell c-coms | malevolent creations c-com | [https://web.archive.org/web/20110904002924/http://lenshellarchive.com/Progs/aolccoms/malevolent.zip](https://web.archive.org/web/20110904002924/http://lenshellarchive.com/Progs/aolccoms/malevolent.zip) | [http://lenshellarchive.com/Progs/aolccoms/malevolent.zip](http://lenshellarchive.com/Progs/aolccoms/malevolent.zip) |
