...
The catalog metadata and filename do not identify a confident single function yet. These need readme/source review or isolated inspection. Readable archive text also suggests: Idler / AFK bot, C-Com / command list.
...
| Field | Value |
| --- | --- |
| Archive ID | prog-1358-nsidle |
| Catalog number | 1358 |
| Best known name | nsidle |
| Best name source | catalog |
| Catalog label | nsidle |
| Archive filename | nsidle.zip |
| File size | 1.7 MB |
| Author | unknown |
...
- Local mirrored archive: [files/aol/aol-4-0/1358-nsidle.zip](../../../../../files/aol/aol-4-0/1358-nsidle.zip)
- Old-web / Wayback download leads: 1 link(s) listed below
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/nsidle.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/nsidle.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/nsidle.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/nsidle.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/nsidle.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| readme.txt | none | Idler / AFK bot<br>C-Com / command list | none | none | none | readme.txt has vocabulary for Idler / AFK bot, C-Com / command list. |
...
| --- | --- | --- | --- |
| LensHell idlers | non stop mp3z idle | [https://web.archive.org/web/20110731021936/http://lenshellarchive.com/Progs/aolidlers/nsidle.zip](https://web.archive.org/web/20110731021936/http://lenshellarchive.com/Progs/aolidlers/nsidle.zip) | [http://lenshellarchive.com/Progs/aolidlers/nsidle.zip](http://lenshellarchive.com/Progs/aolidlers/nsidle.zip) |
