...
| Field | Value |
| --- | --- |
| Archive ID | prog-1357-ns1 |
| Catalog number | 1357 |
| Best known name | Ns 1 |
| Best name source | archive filename |
| Catalog label | ns1 |
| Archive filename | ns1.zip |
| File size | 131 KB |
| Author | canon (catalog-only claim) |
...
| Archive text files reviewed | canons cabin.txt<br>dbpush.txt |
...
- Local mirrored archive: [files/aol/aol-4-0/1357-ns1.zip](../../../../../files/aol/aol-4-0/1357-ns1.zip)
- Old-web / Wayback download leads: not matched yet
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ns1.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ns1.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ns1.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ns1.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/ns1.zip)
...
| --- | --- | --- | --- | --- | --- | --- |
| canons cabin.txt<br>dbpush.txt | none | Scroller / macro | none | none | none | canons cabin.txt has vocabulary for Scroller / macro. |
