...
| Field | Value |
| --- | --- |
| Archive ID | prog-1352-nos |
| Catalog number | 1352 |
| Best known name | Notox |
| Best name source | archive filename |
| Catalog label | nos |
| Archive filename | notox.zip |
| File size | 918 KB |
| Author | JaHOVa |
| Catalog author | JaHOVa |
...
| Archive text files reviewed | Dog.nit.txt<br>NITR.TXT |
...
- Local mirrored archive: [files/aol/aol-4-0/1352-nos.zip](../../../../../files/aol/aol-4-0/1352-nos.zip)
- Old-web / Wayback download leads: not matched yet
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/notox.zip`
- Reference repository mirror page: [https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/notox.zip](https://github.com/ssstonebraker/aolunderground-proggies/blob/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/notox.zip)
- Reference repository raw mirror: [https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/notox.zip](https://raw.githubusercontent.com/ssstonebraker/aolunderground-proggies/main/programs/AOL/proggies-sorted-deduped/proggies-by-version/4.0/notox.zip)
...
| --- | --- | --- | --- | --- |
| Dog.nit.txt<br>NITR.TXT | none | none | none | unknown |
