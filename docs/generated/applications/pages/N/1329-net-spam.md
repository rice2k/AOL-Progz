...
| Catalog number | 1329 |
| Best known name | Net-Spam |
| Best name source | catalog |
| Catalog label | Net-Spam |
| Archive filename | netspam.zip |
| File size | 1.5 MB |
| Author | unknown |
...
- Catalog reference path: `programs/AOL/proggies-sorted-deduped/proggies-by-version/unknown/netspam.zip`
